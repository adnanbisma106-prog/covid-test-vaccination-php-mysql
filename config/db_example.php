 ...
 * Database Connection Template — InfinityFree / XAMPP ke liye
 * 
 * COPY this file to: config/db.php
 * Phir apni real credentials daalo
 */
...
// =========================================================
//  InfinityFree pe deploy karne ke liye ye values change karo:
// =========================================================
define('DB_HOST', 'localhost');              // InfinityFree: sql123.infinityfree.com
define('DB_USER', 'root');                   // InfinityFree: epiz_XXXXXXX_username
define('DB_PASS', '');                       // Apna password daalo
define('DB_NAME', 'covid_ors_db');           // InfinityFree: epiz_XXXXXXX_dbname
// =========================================================
